...
webpackJsonpL2Dwidget([0], {
    76 : function(t, e, i) {
        ...
        function x(t) {
            var e = t.touches[0];
            "touchstart" == t.type ? 1 == t.touches.length && L(e) : "touchmove" == t.type ?
            function(t) {
                var e = n.currCanvas.getBoundingClientRect(),
                i = w(t.clientX - e.left),
                r = D(t.clientY - e.top),
                ...
                s = A(o.x - e.left),
                a = I(o.y - e.top);
                l.cDefine.DEBUG_MOUSE_LOG && console.log("followPointer onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + a + ")"),
                P && (i, r, d.setPoint(s, a))
            } (e) : "touchend" == t.type && M()
        }
        function A(t) {
        ...
        e.theRealInit = function() { (0, n.createElement)(),
            n.currCanvas.addEventListener && (window.addEventListener("click", E), window.addEventListener("mousedown", E), window.addEventListener("mousemove", E), window.addEventListener("mouseup", E), document.addEventListener("mouseleave", E), window.addEventListener("touchstart", x), window.addEventListener("touchend", x), window.addEventListener("touchmove", x)),
            c = new _.cManager(p.L2Dwidget),
            d = new a.L2DTargetPoint;
            var t = n.currCanvas.getBoundingClientRect(),
            e = t.height / t.width,
            i = l.cDefine.VIEW_LOGICAL_LEFT,
            r = l.cDefine.VIEW_LOGICAL_RIGHT,
            $ = -e,
            P = e; (y = new a.L2DViewMatrix).setScreenRect(i, r, $, P),
            y.setMaxScreenRect(l.cDefine.VIEW_LOGICAL_MAX_LEFT, l.cDefine.VIEW_LOGICAL_MAX_RIGHT, l.cDefine.VIEW_LOGICAL_MAX_BOTTOM, l.cDefine.VIEW_LOGICAL_MAX_TOP),
            S = u.
        default.mobile() && o.config.mobile.scale || o.config.model.scale,
            y.adjustScale(0, 0, S);
            var S; (m = new a.L2DMatrix44).multScale(1, t.width / t.height),
            (T = new a.L2DMatrix44).multTranslate( - t.width / 2, -t.height / 2),
            T.multScale(2 / t.width, -2 / t.height),
            s.Live2D.setGL(n.currWebGL),
            n.currWebGL.clearColor(0, 0, 0, 0),
            v = o.config.model.jsonPath,
            c.reloadFlg = !0,
            c.count++,
            c.changeModel(n.currWebGL, v);
            var v;
            g || (g = !0,
            function t() { !
                function() {
                ...
                e(t, n.currCanvas),
                void 0 !== f && (f(n.currCanvas.toDataURL()), f = void 0)
            } ())
        },
    ...
    77 : function(t, e, i) {
        "use strict"; (function(t) {
            ...
            r.prototype.getModelImpl = function() {
                return null == this._$MT && (this._$MT = new $, this._$MT._$zP()),
                this._$MT
            },
            ...
            r.prototype._$P7 = function(t, e, i, r) {
                ...
                if (0 != i) if (1 == t.length) {
                    ...
                    _ = i / r;
                    s ? (a += _) > 1 && (a = 1) : (a -= _) < 0 && (a = 0),
                    this.setPartsOpacity(p, a)
                } else {
                    for ($ = 0; $ < t.length; $++) {
                        u = t[$];
                    ...
                    for ($ = 0; $ < t.length; $++) {
                        ...
                        if (o == $) this.setPartsOpacity(p, n);
                            ...
                            var h, l = this.getPartsOpacity(p); (1 - (h = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5)) * (1 - n) > .15 && (h = 1 - .15 / (1 - n)),
                            l > h && (l = h),
                            this.setPartsOpacity(p, l)
                        }
                    }
            ...
            o.prototype.releaseShader = function() {
                ...
                e = 0; e < t; e++) this.gl.deleteFramebuffer(at.frameBuffers[e].framebuffer);
                at.frameBuffers = [],
                at.glContext = []
            },
            ...
            o.prototype.setupClip = function(t, e) {
                ...
                if (i > 0) {
                    ...
                    for (r = 0; r < this.clipContextList.length; r++) {
                        ...
                        for (var c = o.clippingMaskDrawIndexList.length,
                        f = 0; f < c; f++) {
            ...
            o.prototype.findSameClip = function(t) {
                for (var e = 0; e < this.clipContextList.length; e++) {
                    ...
                    if (r == t.length) {
                        for (var o = 0,
                        n = 0; n < r; n++) for (var s = i.clipIDList[n], a = 0; a < r; a++) if (t[a] == s) {
                            o++;
                            break
                        }
                        if (o == r) return i
            ...
            o.prototype.calcClippedDrawTotalBounds = function(t, e) {
                for (var i = t._$Ri.getModelImpl().getCanvasWidth(), r = t._$Ri.getModelImpl().getCanvasHeight(), o = i > r ? i: r, n = o, s = o, a = 0, _ = 0, h = e.clippedDrawContextList.length, l = 0; l < h; l++) {
                    ...
                    u = t._$C2($);
                    if (u._$yo()) {
                        for (var p = u.getTransformedPoints(), c = p.length, f = [], g = [], d = 0, y = B._$i2; y < c; y += B._$No) f[d] = p[y],
                        g[d] = p[y + 1],
                        d++;
            ...
            o.prototype.setupLayoutBounds = function(t) {
                ...
                i = ~~i;
                for (var r = 0,
                n = 0; n < o.CHANNEL_COUNT; n++) {
                    var s = e + (n < i ? 1 : 0);
                    if (0 == s);
                    else if (1 == s) { ($ = this.clipContextList[r++]).layoutChannelNo = n,
                        $.layoutBounds.x = 0,
                        $.layoutBounds.y = 0,
                        ...
                        var h = 0;
                        l = ~~ (l = _ % 2); ($ = this.clipContextList[r++]).layoutChannelNo = n,
                        $.layoutBounds.x = .5 * l,
                        $.layoutBounds.y = 0,
                        ...
                        l = ~~ (l = _ % 2),
                        h = ~~ (h = _ / 2); ($ = this.clipContextList[r++]).layoutChannelNo = n,
                        $.layoutBounds.x = .5 * l,
                        $.layoutBounds.y = .5 * h,
                        $.layoutBounds.width = .5,
                        ...
                        l = ~~ (l = _ % 3),
                        h = ~~ (h = _ / 3);
                        var $; ($ = this.clipContextList[r++]).layoutChannelNo = n,
                        $.layoutBounds.x = l / 3,
                        $.layoutBounds.y = h / 3,
            ...
            h.getID = function(t) {
                var e = h._$tP[t];
                return null == e && (e = new h(t), h._$tP[t] = e),
                e
            },
            ...
            T._$ni = function(t, e, i, r, o, n, s, a, _) {
                ...
                isNaN(l) && (l = (t - i - $ * s) / o, isNaN(l) && (l = (e - r - $ * a) / n), isNaN(l) && (console.log("a is NaN @UtVector#_$ni() "), console.log("v1x : " + o), console.log("v1x != 0 ? " + (0 != o)))),
            ...
            S._$Z2 = function(t, e, i, r) {
                ...
                for (var U = 1 << o,
                Y = new Float32Array(U), k = 0; k < U; k++) {
                    for (var V = k,
                    X = 1,
            ...
            S._$br = function(t, e, i, r) {
                ...
                for (var G = 1 << o,
                U = new Float32Array(G), Y = 0; Y < G; Y++) {
                    for (var k = Y,
                    V = 1,
            ...
            S._$Vr = function(t, e, i, r, o, n, s, a) {
                ...
                if (_ <= 0) {
                    ...
                    S = b * g,
                    v = b * m;
                    for (c = 0; c < $;) n[u] = T * p[c] + P * f[c] + S * d[c] + v * y[c],
                    ++c,
                    n[u + 1] = T * p[c] + P * f[c] + S * d[c] + v * y[c],
                    ++c,
                    u += a
                } else if (3 == _) {
                    var L = o[h[0]],
                    ...
                    U = st * b * g,
                    Y = st * b * m;
                    for (c = 0; c < $;) n[u] = R * L[c] + F * M[c] + C * E[c] + N * x[c] + B * I[c] + G * w[c] + U * D[c] + Y * O[c],
                    ++c,
                    n[u + 1] = R * L[c] + F * M[c] + C * E[c] + N * x[c] + B * I[c] + G * w[c] + U * D[c] + Y * O[c],
                    ++c,
                    u += a
                } else if (4 == _) {
                    var k, V, X = o[h[0]],
                    ...
                    vt = at * st * b * g,
                    Lt = at * st * b * m;
                    for (c = 0; c < $;) n[u] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + dt * Z[c] + yt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + St * rt[c] + vt * ot[c] + Lt * nt[c],
                    ++c,
                    n[u + 1] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + dt * Z[c] + yt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + St * rt[c] + vt * ot[c] + Lt * nt[c],
                    ++c,
                    u += a
                } else {
                    for (var Mt = 1 << _,
                    Et = new Float32Array(Mt), xt = 0; xt < Mt; xt++) {
                        for (var At = xt,
                        It = 1,
                        wt = 0; wt < _; wt++) It *= At % 2 == 0 ? 1 - l[wt] : l[wt],
                        At /= 2;
                        Et[xt] = It
                    }
                    ...
                    for (c = 0; c < $;) {
                        ...
                        Rt = 0,
                        Ft = c + 1;
                        for (Ot = 0; Ot < Mt; Ot++) bt += Et[Ot] * Dt[Ot][c],
                        Rt += Et[Ot] * Dt[Ot][Ft];
                        c += 2,
                        n[u] = bt,
                        n[u + 1] = Rt,
            ...
            I.prototype.getParamIndex = function(t) {
                return this._$2r != t && (this._$8o = I._$ds),
                this._$8o
            },
            ...
            b.getID = function(t) {
                var e = b._$tP[t];
                return null == e && (e = new b(t), b._$tP[t] = e),
                e
            },
            ...
            R.prototype.transform = function(t, e, i) {
                ...
                default:
                    return;
                case R._$go | R._$fo | R._$gb: for (r = this._$7, o = this._$H, n = this._$k, s = this._$f, a = this._$g, _ = this._$w; --i >= 0;) {
                        var $ = t[h++],
                        u = t[h++];
                        e[l++] = r * $ + o * u + n,
                        e[l++] = s * $ + a * u + _
                    ...
                    return;
                case R._$go | R._$fo: for (r = this._$7, o = this._$H, s = this._$f, a = this._$g; --i >= 0;) {
                        $ = t[h++],
                        u = t[h++];
                        e[l++] = r * $ + o * u,
                        e[l++] = s * $ + a * u
                    ...
                    return;
                case R._$go | R._$gb: for (o = this._$H, n = this._$k, s = this._$f, _ = this._$w; --i >= 0;) {
                        $ = t[h++];
                        e[l++] = o * t[h++] + n,
                        e[l++] = s * $ + _
                    }
                ...
                case R._$go:
                    ...
                    return;
                case R._$fo | R._$gb: for (r = this._$7, n = this._$k, a = this._$g, _ = this._$w; --i >= 0;) e[l++] = r * t[h++] + n,
                    e[l++] = a * t[h++] + _;
                    return;
                case R._$fo:
                    for (r = this._$7, a = this._$g; --i >= 0;) e[l++] = r * t[h++],
                    e[l++] = a * t[h++];
                    return;
                case R._$gb:
                    for (n = this._$k, _ = this._$w; --i >= 0;) e[l++] = t[h++] + n,
                    e[l++] = t[h++] + _;
                    return;
                ...
                for (var o = 0; o < r; ++o) {
                    ...
                    if ("\n" != n && "\r" != n) if ("#" != n) if ("$" != n) {
                        if ("a" <= n && n <= "z" || "A" <= n && n <= "Z" || "_" == n) {
                            ...
                            if (l >= 0) {
                                var s = new N;
                                w.startsWith(t, h, F._$cs) ? (s._$RP = N._$hs, s._$4P = new String(t, h, l - h)) : w.startsWith(t, h, F._$ar) ? (s._$4P = new String(t, h + 7, l - h - 7), w.startsWith(t, h + 7, "ANCHOR_X") ? s._$RP = N._$xs: w.startsWith(t, h + 7, "ANCHOR_Y") ? s._$RP = N._$us: w.startsWith(t, h + 7, "SCALE_X") ? s._$RP = N._$qs: w.startsWith(t, h + 7, "SCALE_Y") ? s._$RP = N._$Ys: w.startsWith(t, h + 7, "X") ? s._$RP = N._$ws: w.startsWith(t, h + 7, "Y") && (s._$RP = N._$Ns)) : (s._$RP = N._$Fr, s._$4P = new String(t, h, l - h)),
                                e.motions.push(s);
                                var a = 0;
            ...
            U.prototype.init = function() {
                ...
                d = dt._$2o();;) {
                    ...
                    for (s = 0; s < g; ++s) {
                        var m = r[s];
                        if (null != m) {
                            var T = m.getTargetBaseDataID(); (null == T || T == d || this.getBaseDataIndex(T) >= 0) && (this._$3S.push(m), this._$db.push(n[s]), r[s] = null, y = !0)
                        }
                    }
                    if (!y) break
                }
            ...
            U.prototype.update = function() {
                ...
                e = 0; e < t; e++) this._$_2[e] != this._$vr[e] && (this._$Js[e] = U._$ZS, this._$vr[e] = this._$_2[e]);
                var i = this._$3S.length,
                r = this._$aS.length,
                o = W._$or(),
                n = W._$Pr() - o + 1; (null == this._$Ws || this._$Ws.length < n) && (this._$Ws = new Int16Array(n), this._$Vs = new Int16Array(n));
                for (e = 0; e < n; e++) this._$Ws[e] = U._$V2,
                this._$Vs[e] = U._$V2; (null == this._$Er || this._$Er.length < r) && (this._$Er = new Int16Array(r));
            ...
            k.prototype._$7T = function(t) {
                ...
                switch (this._$_L) {
                case STATE_CLOSING:
                    (r = (i - this._$bb) / this._$Dr) >= 1 && (r = 1, this._$_L = V.STATE_CLOSED, this._$bb = i),
                    e = 1 - r;
                    break;
                case STATE_CLOSED:
                    (r = (i - this._$bb) / this._$Cb) >= 1 && (this._$_L = V.STATE_OPENING, this._$bb = i),
                    e = 0;
                    break;
                case STATE_OPENING:
                    (r = (i - this._$bb) / this._$mr) >= 1 && (r = 1, this._$_L = V.STATE_INTERVAL, this._$12 = this._$T2()),
                    e = r;
                    break;
                case STATE_INTERVAL:
                    this._$12 < i && (this._$_L = V.STATE_CLOSING, this._$bb = i),
                    e = 1;
                    break;
                case STATE_FIRST:
                default:
            ...
            X._$cr = function(t, e) {
                return null == t || t._$yL() < e.length ? ((t = X._$9r(2 * e.length)).put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)),
                t
            },
            X._$mb = function(t, e) {
                return null == t || t._$yL() < e.length ? ((t = X._$vb(2 * e.length)).put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)),
                t
            },
            X._$Hs = function() {
                return X._$Gr
            ...
            z.prototype._$Nr = function(t, e) {
                ...
                if (this._$GS._$Ur(t)) {
                    ...
                    if (this._$GS._$zr(n, s, o), o <= 0) {
                        ...
                        nt = 0,
                        st = 0;
                        for (et = 0; et < j; et++) it += q[et] * tt[et]._$fL,
                        rt += q[et] * tt[et]._$gL,
                        ot += q[et] * tt[et]._$B0,
                        nt += q[et] * tt[et]._$z0,
                        st += q[et] * tt[et]._$qT;
            ...
            z.prototype._$2b = function(t, e) {
                ...
                if (i._$hS(!0), this._$32()) {
                    ...
                    if (i._$8r == x._$ur && (i._$8r = t.getBaseDataIndex(r)), i._$8r < 0) at._$so && a._$li("_$L _$0P _$G :: %s", r),
                    i._$hS(!1);
                    else {
                        ...
                        if (null != o) {
                            ...
                            i._$Wr._$qT = i._$Yr._$qT - l * vt._$NS;
                            var $ = n.getTotalScale();
            ...
            z.prototype._$nb = function(t, e, i, r, o, n, s) {
                this != e._$GT() && console.log("### assert!! ### ");
                for (var a, _, h = e,
                l = null != h._$Wr ? h._$Wr: h._$Yr, $ = Math.sin(vt._$bS * l._$qT), u = Math.cos(vt._$bS * l._$qT), p = h.getTotalScale(), c = l.reflectX ? -1 : 1, f = l.reflectY ? -1 : 1, g = u * p * c, d = -$ * p * f, y = $ * p * c, m = u * p * f, T = l._$fL, P = l._$gL, S = o * s, v = n; v < S; v += s) a = i[v],
                _ = i[v + 1],
                r[v] = g * a + d * _ + T,
                r[v + 1] = y * a + m * _ + P
            },
            z.prototype._$Jr = function(t, e, i, r, o, n) {
                ...
                h = 1,
                l = 0; l < 10; l++) {
                    if (_[0] = r[0] + h * o[0], _[1] = r[1] + h * o[1], e._$nb(t, i, _, a, 1, 0, 2), a[0] -= s[0], a[1] -= s[1], 0 != a[0] || 0 != a[1]) return n[0] = a[0],
                    void(n[1] = a[1]);
                    if (_[0] = r[0] - h * o[0], _[1] = r[1] - h * o[1], e._$nb(t, i, _, a, 1, 0, 2), a[0] -= s[0], a[1] -= s[1], 0 != a[0] || 0 != a[1]) return a[0] = -a[0],
                    a[0] = -a[0],
                    n[0] = a[0],
                    void(n[1] = a[1]);
                    h *= .1
                ...
                for (var o = 0; o < r; ++o) {
                    ...
                    if ("\n" != n && "\r" != n) if ("#" != n) if ("$" != n) {
                        if (97 <= s && s <= 122 || 65 <= s && s <= 90 || "_" == n) {
                            ...
                            if (u >= 0) {
                                var a = new N;
                                w.startsWith(t, $, J._$cs) ? (a._$RP = N._$hs, a._$4P = w.createString(t, $, u - $)) : w.startsWith(t, $, J._$ar) ? (a._$4P = w.createString(t, $ + 7, u - $ - 7), w.startsWith(t, $ + 7, "ANCHOR_X") ? a._$RP = N._$xs: w.startsWith(t, $ + 7, "ANCHOR_Y") ? a._$RP = N._$us: w.startsWith(t, $ + 7, "SCALE_X") ? a._$RP = N._$qs: w.startsWith(t, $ + 7, "SCALE_Y") ? a._$RP = N._$Ys: w.startsWith(t, $ + 7, "X") ? a._$RP = N._$ws: w.startsWith(t, $ + 7, "Y") && (a._$RP = N._$Ns)) : (a._$RP = N._$Fr, a._$4P = w.createString(t, $, u - $)),
                                e.motions.push(a);
                                var _ = 0,
                                h = [];
                                for (o = u + 1; o < r && ("\r" != (n = Q(t, o)) && "\n" != n); ++o) if ("," != n && " " != n && "\t" != n) {
            ...
            Z.transformPoints_sdk2 = function(e, i, r, o, n, s, a, _) {
                ...
                T = o; T < u; T += n) {
                    ...
                    if (v = e[T], S = (L = e[T + 1]) * _, (P = v * a) < 0 || S < 0 || a <= P || _ <= S) {
                        ...
                        if (!m) {
                            m = !0,
                            p = .25 * (s[2 * (0 + 0 * M)] + s[2 * (a + 0 * M)] + s[2 * (0 + _ * M)] + s[2 * (a + _ * M)]),
                            c = .25 * (s[2 * (0 + 0 * M) + 1] + s[2 * (a + 0 * M) + 1] + s[2 * (0 + _ * M) + 1] + s[2 * (a + _ * M) + 1]);
                        ...
                        if ( - 2 < v && v < 3 && -2 < L && L < 3) if (v <= 0) if (L <= 0) {
                            ...
                            F = c - 2 * y,
                            C = p - 2 * f - 2 * d,
                            N = c - 2 * g - 2 * y; (B = .5 * (v - -2)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                        } else if (L >= 1) {
                            R = s[2 * (0 + _ * M)],
                            F = s[2 * (0 + _ * M) + 1],
                            C = p - 2 * f + 1 * d,
                            ...
                            D = c + 3 * y,
                            O = p - 2 * f + 3 * d,
                            b = c - 2 * g + 3 * y; (B = .5 * (v - -2)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                        } else { (k = 0 | S) == _ && (k = _ - 1);
                            var B = .5 * (v - -2),
                            G = S - k,
                            U = k / _,
                            ...
                            N = c + 1 * g - 2 * y,
                            R = p + 3 * f - 2 * d,
                            F = c + 3 * g - 2 * y; (B = .5 * (v - 1)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                        } else if (L >= 1) {
                            C = s[2 * (a + _ * M)],
                            N = s[2 * (a + _ * M) + 1],
                            R = p + 3 * f + 1 * d,
                            ...
                            b = c + 1 * g + 3 * y,
                            w = p + 3 * f + 3 * d,
                            D = c + 3 * g + 3 * y; (B = .5 * (v - 1)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G))
                        } else {
                            var k; (k = 0 | S) == _ && (k = _ - 1);
                            B = .5 * (v - 1),
                            G = S - k,
                        ...
                        i[T + 1] = c + v * g + L * y
                    } else h = 2 * ((0 | P) + (0 | S) * (a + 1)),
                    (l = P - (0 | P)) + ($ = S - (0 | S)) < 1 ? (i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (a + 1)] * $, i[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (a + 1) + 1] * $) : (i[T] = s[h + 2 * (a + 1) + 2] * (l - 1 + $) + s[h + 2 * (a + 1)] * (1 - l) + s[h + 2] * (1 - $), i[T + 1] = s[h + 2 * (a + 1) + 3] * (l - 1 + $) + s[h + 2 * (a + 1) + 1] * (1 - l) + s[h + 3] * (1 - $))
                }
            },
            Z.prototype.transformPoints_sdk1 = function(t, e, i, r, o, n, s) {
                ...
                g = this._$A,
                d = o * s,
                y = null != c._$hr ? c._$hr: c._$Cr, m = n; m < d; m += s) at._$ts ? (a = i[m], _ = i[m + 1], a < 0 ? a = 0 : a > 1 && (a = 1), _ < 0 ? _ = 0 : _ > 1 && (_ = 1), l = 0 | (_ *= g), (h = 0 | (a *= f)) > f - 1 && (h = f - 1), l > g - 1 && (l = g - 1), u = a - h, p = _ - l, $ = 2 * (h + l * (f + 1))) : (u = (a = i[m] * f) - (0 | a), p = (_ = i[m + 1] * g) - (0 | _), $ = 2 * ((0 | a) + (0 | _) * (f + 1))),
                u + p < 1 ? (r[m] = y[$] * (1 - u - p) + y[$ + 2] * u + y[$ + 2 * (f + 1)] * p, r[m + 1] = y[$ + 1] * (1 - u - p) + y[$ + 3] * u + y[$ + 2 * (f + 1) + 1] * p) : (r[m] = y[$ + 2 * (f + 1) + 2] * (u - 1 + p) + y[$ + 2 * (f + 1)] * (1 - u) + y[$ + 2] * (1 - p), r[m + 1] = y[$ + 2 * (f + 1) + 3] * (u - 1 + p) + y[$ + 2 * (f + 1) + 1] * (1 - u) + y[$ + 3] * (1 - p))
            },
            ...
            ot.prototype.drawElements = function(t, e, i, r, o, n, s, _) {
                try {
                    ...
                    S = 0; S < h; S += 3) {
                        ...
                        T._$ni(C, N, O, b, R - O, F - b, -(F - b), R - O, y),
                        T._$ni(w, D, E, x, A - E, I - x, -(I - x), A - E, m);
                        var H = (m[0] - y[0]) / y[1],
                        W = Math.min(O, R, C),
                        j = Math.max(O, R, C),
                        q = Math.min(b, F, N),
                        ...
                        if (n || (n = 1.2), at.IGNORE_EXPAND && (n = 0), at.USE_CACHED_POLYGON_IMAGE) {
                            ...
                            !et.gl_cacheImage[S]) {
                                ...
                                rt.translate( - Q, -Z),
                                ot.clip(rt, d, n, k, O, b, R, F, C, N, E, x, A, I, w, D),
                                rt.drawImage(t, 0, 0),
                                et.gl_cacheImage[S] = {
                                    cacheCanvas: it,
                                    cacheContext: rt
                        ...
                        } else at.IGNORE_CLIP || ot.clip(u, d, n, k, O, b, R, F, C, N, E, x, A, I, w, D),
            ...
            lt.prototype.init = function(t) {
                ...
                case B._$Qs:
                    for (o = this._$d0 - 1; o >= 0; --o) {
                        ...
                        e._$Cr[s + 1] = _,
                        e._$Cr[s + 4] = 0,
                        r && (e._$hr[s] = a, e._$hr[s + 1] = _, e._$hr[s + 4] = 0)
                    }
                }
                return e
            },
            ...
            ct.prototype.startMotion = function(t, e) {
                ...
                o = 0; o < r; ++o) null != (i = this.motions[o]) && (i._$qS(i._$w0.getFadeOut()), this._$eb && a._$Ji("MotionQueueManager[size:%2d]->startMotion() / start _$K _$3 (m%d)\n", r, i._$sr));
                if (null == t) return - 1; (i = new ft)._$w0 = t,
                this.motions.push(i);
                var n = i._$sr;
            ...
            ft.prototype._$qS = function(t) {
                var e = A.getUserTimeMSec() + t; (this._$Do < 0 || e < this._$Do) && (this._$Do = e)
            },
            ...
            yt._$cr = function(t, e) {
                return null == t || t._$yL() < e.length ? ((t = yt._$9r(2 * e.length)).put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)),
                t
            },
            yt._$mb = function(t, e) {
                return null == t || t._$yL() < e.length ? ((t = yt._$vb(2 * e.length)).put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)),
                t
            },
            yt._$Hs = function() {
                return this._$Gr
            ...
            yt.prototype._$Uo = function(t, e, i, r, o, n, s, a) {
                if (! (n < .01 && null == this.clipBufPre_clipContextMask)) {
                    ...
                    if (null != this.clipBufPre_clipContextMask) {
                        ...
                        _.uniform4f(this.u_baseColor_Loc, 2 * f.x - 1, 2 * f.y - 1, 2 * f._$EL() - 1, 2 * f._$5T() - 1),
                        ...
                        c = this.getChannelFlagAsColor(p);
                        _.uniform4f(this.u_channelFlag_Loc_Off, c.r, c.g, c.b, c.a),
                        _.uniform4f(this.u_baseColor_Loc_Off, h, l, $, u)
                    ...
                    _.uniform4f(this.u_baseColor_Loc, h, l, $, u),
                    _.uniform1i(this.u_maskFlag_Loc, !1);
                    this.culling ? this.gl.enable(_.CULL_FACE) : this.gl.disable(_.CULL_FACE),
                    this.gl.enable(_.BLEND);
                    var g, d, y, m;
                    if (null != this.clipBufPre_clipContextMask) g = _.ONE,
                    d = _.ONE_MINUS_SRC_ALPHA,
                    y = _.ONE,
                    m = _.ONE_MINUS_SRC_ALPHA;
                    else switch (s) {
                    case lt._$ms:
                        g = _.ONE,
                        d = _.ONE_MINUS_SRC_ALPHA,
            ...
            yt.prototype.compileShader = function(t, e) {
                ...
                r = e,
                o = i.createShader(t);
                if (null == o) return a._$Ji("_$L0 to create shader"),
                null;
                i.shaderSource(o, r),
                i.compileShader(o);
            ...
            Pt.prototype._$bT = function() {
                ...
                try {
                    var o = new Array;
                    if (null == e) for (r = 0; r < t; ++r) o[r] = this._$T.getUint8(this._$F++);
                    else for (r = 0; r < t; ++r) o[r] = e[r];
                    return String.fromCharCode.apply(null, o)
                } catch(t) {
            ...
            vt._$NS = 180 / Math.PI,
            vt.PI_F = Math.PI,
            vt._$kT = [0, .012368, .024734, .037097, .049454, .061803, .074143, .086471, .098786, .111087, .12337, .135634, .147877, .160098, .172295, .184465, .196606, .208718, .220798, .232844, .244854, .256827, .268761, .280654, .292503, .304308, .316066, .327776, .339436, .351044, .362598, .374097, .385538, .396921, .408243, .419502, .430697, .441826, .452888, .463881, .474802, .485651, .496425, .507124, .517745, .528287, .538748, .549126, .559421, .56963, .579752, .589785, .599728, .609579, .619337, .629, .638567, .648036, .657406, .666676, .675843, .684908, .693867, .70272, .711466, .720103, .72863, .737045, .745348, .753536, .76161, .769566, .777405, .785125, .792725, .800204, .807561, .814793, .821901, .828884, .835739, .842467, .849066, .855535, .861873, .868079, .874153, .880093, .885898, .891567, .897101, .902497, .907754, .912873, .917853, .922692, .92739, .931946, .936359, .940629, .944755, .948737, .952574, .956265, .959809, .963207, .966457, .96956, .972514, .97532, .977976, .980482, .982839, .985045, .987101, .989006, .990759, .992361, .993811, .995109, .996254, .997248, .998088, .998776, .999312, .999694, .999924, 1],
            ...
            Mt.setup = function() {
                ...
                if ((i = t.indexOf("iPhone OS ")) >= 0) r.os = "iPhone",
                r._isIPhone = !0,
                r.version = e(t, i + "iPhone OS ".length);
                else if ((i = t.indexOf("iPad")) >= 0) {
                    if ((i = t.indexOf("CPU OS")) < 0) return void a._$li(" err : " + t + " @UtHtml5.setup()");
                    r.os = "iPad",
                    r._isIPad = !0,
                    r.version = e(t, i + "CPU OS ".length)
    ...
    78 : function(t, e, i) {
        ...
        _.prototype.updateParam = function(t) {
            ...
            case h.STATE_CLOSING:
                (o = (i - this.stateStartTime) / this.closingMotionMsec) >= 1 && (o = 1, this.eyeState = h.STATE_CLOSED, this.stateStartTime = i),
                e = 1 - o;
                break;
            case h.STATE_CLOSED:
                (o = (i - this.stateStartTime) / this.closedMotionMsec) >= 1 && (this.eyeState = h.STATE_OPENING, this.stateStartTime = i),
                e = 0;
                break;
            case h.STATE_OPENING:
                (o = (i - this.stateStartTime) / this.openingMotionMsec) >= 1 && (o = 1, this.eyeState = h.STATE_INTERVAL, this.nextBlinkTime = this.calcNextBlink()),
                e = o;
                break;
            case h.STATE_INTERVAL:
                this.nextBlinkTime < i && (this.eyeState = h.STATE_CLOSING, this.stateStartTime = i),
                e = 1;
                break;
            case h.STATE_FIRST:
            default:
        ...
        p.load = function(t) {
            for (var e = new p,
            i = y.getPlatformManager().jsonParseFromBytes(t).physics_hair, o = i.length, n = 0; n < o; n++) {
                var s = i[n],
                a = new r.PhysicsHair,
                _ = s.setup,
                ...
                for (f = 0; f < v; f++) {
                    ...
                    T = parseFloat(M.scale),
                    P = parseFloat(M.weight);
        ...
        c.load = function(t) {
            for (var e = new c,
            i = y.getPlatformManager().jsonParseFromBytes(t).parts_visible, r = i.length, o = 0; o < r; o++) {
        ...
        c.prototype.normalizePartsOpacityGroup = function(t, e, i) {
            ...
            for (n = 0; n < e.length; n++) {
                if (! ((s = e[n].partsIndex) < 0)) if (r == n) t.setPartsOpacity(s, o);
                else {
                    var _, h = t.getPartsOpacity(s); (1 - (_ = o < .5 ? -.5 * o / .5 + 1 : .5 * (1 - o) / .5)) * (1 - o) > .15 && (_ = 1 - .15 / (1 - o)),
                    h > _ && (h = _),
        ...
        g.prototype.update = function() {
            ...
            if (0 != this.lastTimeSec) {
                ...
                if (! (Math.abs(n) <= this.EPSILON && Math.abs(s) <= this.EPSILON)) {
                    ...
                    h = t * n / a - this.faceVX,
                    l = _ - this.faceVY,
                    $ = Math.sqrt(h * h + l * l); ($ < -o || $ > o) && (h *= o / $, l *= o / $, $ = o),
                    this.faceVX += h,
                    this.faceVY += l;
        ...
        d.prototype = new l,
        d.prototype.adjustTranslate = function(t, e) {
        ...
        function y() {}
        y.platformManager = null,
        y.getPlatformManager = function() {
    ...
    80 : function(t, e, i) {
        ...
        e.createElement = function() {
            ...
            r.config.dialog.enable && (0, n.createDialogElement)(i);
    ...
    82 : function(t, e, i) {
        ...
        t.exports = {
            createDialogElement: function(t) { (n = document.createElement("div")).className = "live2d-widget-dialog-container",
                n.style.transform = "scale(" + r.config.display.width / 250 + ")",
                (s = document.createElement("div")).className = "live2d-widget-dialog",
                n.appendChild(s),
                t.appendChild(n),
                o.L2Dwidget.emit("create-dialog", n),
                r.config.dialog.hitokoto && $()
            },
            displayDialog: _,
            hiddenDialog: h,
            alertText: l,
    ...
    86 : function(t, e, i) {
                    ...
                    for (var e = 0; e < n.modelSetting.getTextureNum(); e++) {
                        ...
                        function() {
                            if (n.isTexLoaded) {
                                ...
                                } else n.expressionManager = null,
                                n.expressions = {};
                                if (null == n.eyeBlink && (n.eyeBlink = new r.L2DEyeBlink), null != n.modelSetting.getPhysicsFile() ? n.loadPhysics(n.modelHomeDir + n.modelSetting.getPhysicsFile()) : n.physics = null, null != n.modelSetting.getPoseFile() ? n.loadPose(n.modelHomeDir + n.modelSetting.getPoseFile(),
                                function() {
        ...
        _.prototype.startMotion = function(t, e, i) {
            ...
            if (null != r && "" != r) {
                ...
                var o, n = this;
                null == this.motions[t] ? this.loadMotion(t, this.modelHomeDir + r,
                function(r) {
                    o = r,
    ...
    87 : function(t, e, i) {
        ...
        o.prototype.loadModelSetting = function(t, e) {
            var i = this;
            r.Live2DFramework.getPlatformManager().loadBytes(t,
            function(t) {
