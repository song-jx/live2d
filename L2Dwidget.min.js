...
function(t, n, e) {
    ...
    (t.exports = function(t, n, e, u) {
        ...
        t[n] !== e && (a && (i(e, c) || o(e, c, t[n] ? "" + t[n] : s.join(String(n)))), t === r ? t[n] = e: u ? t[n] ? t[n] = e: o(t, n, e) : (delete t[n], o(t, n, e)))
...
function(t, n, e) {
    ...
    s = function(t, n, e) {
        ...
        x = g[a] || (g[a] = {});
        h && (e = n);
        for (f in e) p = ((l = !v && w && void 0 !== w[f]) ? w: e)[f],
        d = b && l ? u(p, r) : m && "function" == typeof p ? u(Function.call, p) : p,
        w && c(w, f, p, t & s.U),
        g[f] != p && i(g, f, d),
        m && x[f] != p && (x[f] = p)
    };
...
function(t, n, e) {
    ...
    f.addEventListener("message", g, !1)) : r = b in s("script") ?
    function(t) {
    ...
    s = new(function() {
        ...
        },
        {
            ...
            value: function(t) {
                ...
                e = Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++) e[r - 1] = arguments[r];
        ...
        },
        {
            ...
            value: function() {
                var t = this,
                n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}; (0, u.configApplyer)(n),
                this.emit("config", this.config),
                !u.config.mobile.show && c.
            default.mobile() || e.e(0).then(e.bind(null, 76)).then(function(n) { (a = n).theRealInit(t)
                }).
                catch(function(t) {
                    console.error(t)
                })
...
function(t, n, e) {
    ...
    var c = {};
    n.configApplyer = function(t) { (0, o.
    default)(c, t, r.
    default)
    },
    n.config = c
...
function(t, n, e) {
    ...
    R = function(t) {
        ...
        if (!e._d) {
            ...
            e = e._w || e;
            try {
                if (e === t) throw S("Promise can't be resolved itself"); (n = E(t)) ? b(function() {
                    var r = {
                        _w: e,
                        _d: !1
                    };
